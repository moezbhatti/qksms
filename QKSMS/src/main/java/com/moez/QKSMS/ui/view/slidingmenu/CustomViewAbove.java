...
public class CustomViewAbove extends ViewGroup {
    ...
    private static final Interpolator sInterpolator = t -> (float) Math.pow(0.63 * t - 1.0f, 5) + 1.0f;
    ...
    public interface OnPageChangeListener {
         ...
         */
        void onPageSelected(int position, boolean anim);
    ...
    public void setCurrentItem(int item, boolean smoothScroll) {
        setCurrentItem(item, smoothScroll, false);
    }
     ...
     * @param item         Item index to select
     * @param smoothScroll True to smoothly scroll to the new item, false to transition immediately
     * @param notify       True if the open and close listeners should be notified.
     */
    public void setCurrentItem(int item, boolean smoothScroll, boolean notify) {
        setCurrentItemInternal(item, smoothScroll, false, 0, notify);
    }
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity) {
        setCurrentItemInternal(item, smoothScroll, always, velocity, false);
    }

    void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity, boolean notify) {
        ...
        if (dispatchSelected && mOnPageChangeListener != null) {
            mOnPageChangeListener.onPageSelected(item, smoothScroll);
        }
        if (dispatchSelected && mInternalPageChangeListener != null) {
            mInternalPageChangeListener.onPageSelected(item, smoothScroll);
        }
        if (smoothScroll) {
    ...
    /**
     * True if the user has tapped DOWN, and so tapping UP means that the drawer should open.
     */
