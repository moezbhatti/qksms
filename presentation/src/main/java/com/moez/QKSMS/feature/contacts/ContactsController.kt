...
import com.moez.QKSMS.databinding.ContactsControllerBinding
...
import com.moez.QKSMS.feature.contacts.injection.ContactsModule
...
class ContactsController(
    ...
    val chips: HashMap<String, String?> = hashMapOf()
) : QkController<ContactsContract, ContactsState, ContactsPresenter, ContactsControllerBinding>(
        ContactsControllerBinding::inflate
), ContactsContract {

    @Inject override lateinit var presenter: ContactsPresenter
    ...
    override fun onViewCreated() {
        ...
        if (Build.VERSION.SDK_INT <= 22) {
            binding.search.setBackgroundTint(activity!!.resolveThemeColor(R.attr.bubbleColor))
        }
    }
    ...
    override fun finish(result: HashMap<String, String?>) {
        ...
        val intent = Intent().putExtra(ContactsActivity.ChipsKey, result)
