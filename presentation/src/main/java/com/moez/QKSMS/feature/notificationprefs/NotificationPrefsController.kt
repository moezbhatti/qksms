...
import com.moez.QKSMS.databinding.NotificationPrefsPresenterBinding
import com.moez.QKSMS.feature.notificationprefs.injection.NotificationPrefsModule
...
class NotificationPrefsController(
    val threadId: Long = 0
) : QkController<NotificationPrefsView, NotificationPrefsState, NotificationPrefsPresenter, NotificationPrefsPresenterBinding>(
        NotificationPrefsPresenterBinding::inflate
), NotificationPrefsView {

    @Inject override lateinit var presenter: NotificationPrefsPresenter
    ...
    init {
        appComponent
                .notificationPrefsBuilder()
                .contactsModule(NotificationPrefsModule(this))
                .build()
                .inject(this)
    }
    ...
    override fun showPreviewModeDialog() = previewModeDialog.show(activity!!)
