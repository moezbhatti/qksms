...
public class PduHeaders {
    private static final String TAG = "PduHeaders";
    /**
    ...
    public String toString() {
        ...
        for (Map.Entry<Integer, Object> entry : mHeaderMap.entrySet()) {
            builder.append(getFieldName(entry.getKey()));
            builder.append(": ");
            if (entry.getValue() instanceof Integer) {
                // All integer values seem to be codes, so use the getValueName method.
                builder.append(getValueName(entry.getKey(), (Integer) entry.getValue()));
            } else if (entry.getValue() instanceof Long) {
                // Could be a date, a number of bytes, or just a generic size value.
                builder.append(getLongValueString(entry.getKey(), (Long)entry.getValue()));
            } else if (entry.getValue() instanceof byte[]) {
                // Strings are encoded in the headers as byte arrays.
                builder.append(new String((byte[]) entry.getValue()))
                        .append( " (TextString / byte[])");
            } else if (entry.getValue() instanceof EncodedStringValue) {
                // ... and also as EncodedStringValue.
                builder.append(entry.getValue())
                        .append(" (EncodedStringValue)");
            } else {
                builder.append(entry.getValue());
                builder.append(" (")
    ...
    public static String getFieldName(int field) {
        switch (field) {
            ...
            // this is really odd---the headers have the same ids!
            //case 0x90:
            //    return "READ_REPLY";
            case 0x90:
                return "READ_REPORT";
            ...
            case 0x9B:
                return "READ_STATUS";
            case 0x9C:
                return "REPLY_CHARGING";
            case 0x9D:
                return "REPLY_CHARGING_DEADLINE";
            case 0x9E:
                return "REPLY_CHARGING_ID";
            case 0x9F:
                return "REPLY_CHARGING_SIZE";

            case 0xA0:
                return "PREVIOUSLY_SENT_BY";
            case 0xA1:
                return "PREVIOUSLY_SENT_DATE";
            case 0xA2:
                return "STORE";
            case 0xA3:
                return "MM_STATE";
            ...
            case 0xB3:
                return "LIMIT";
            case 0xB4:
                return "RECOMMENDED_RETRIEVAL_MODE";
            case 0xB5:
                return "RECOMMENDED_RETRIEVAL_MODE_TEXT";
            case 0xB6:
                return "STATUS_TEXT";
            case 0xB7:
                return "APPLIC_ID";
            case 0xB8:
                return "REPLY_APPLIC_ID";
            case 0xB9:
                return "AUX_APPLIC_ID";
            case 0xBA:
    ...
    public static String getValueName(int field, int value) {
        switch (field) {
            case MESSAGE_TYPE:
                /**
                 * X-Mms-Message-Type field types.
            ...
            case READ_REPORT:
            case REPORT_ALLOWED:
            // Note: Although it lists SENDER_VISIBILITY below, there is a better value for it.
            //case SENDER_VISIBILITY:
            case STORE:
            case STORED:
            case TOTALS:
            ...
            case REPLY_CHARGING_DEADLINE:
                ...
                switch (value) {
                    case 0x80:
                        return "VALUE_ABSOLUTE_TOKEN";
                    case 0x81:
                        return "VALUE_RELATIVE_TOKEN";
                }
            ...
            case FROM:
                ...
                switch (value) {
                    case 0x80:
                        return "FROM_ADDRESS_PRESENT_TOKEN";
                    case 0x81:
                        return "FROM_INSERT_ADDRESS_TOKEN";
                }
            ...
            case MM_FLAGS:
                ...
                switch (value) {
                    case 0x80:
                        return "MM_FLAGS_ADD_TOKEN";
                    case 0x81:
                        return "MM_FLAGS_REMOVE_TOKEN";
                    case 0x82:
                        return "MM_FLAGS_FILTER_TOKEN";
                }
            ...
            case MESSAGE_CLASS:
                ...
                switch (value) {
                    case 0x80:
                        return "MESSAGE_CLASS_PERSONAL";
                    case 0x81:
                        return "MESSAGE_CLASS_ADVERTISEMENT";
                    case 0x82:
                        return "MESSAGE_CLASS_INFORMATIONAL";
                    case 0x83:
                        return "MESSAGE_CLASS_AUTO";
                }
            ...
            case RESPONSE_STATUS:
                ...
                switch (value) {
                    ...
                    case 0x81:
                        return "RESPONSE_STATUS_ERROR_UNSPECIFIED";
                    case 0x82:
                        return "RESPONSE_STATUS_ERROR_SERVICE_DENIED";

                    case 0x83:
                        return "RESPONSE_STATUS_ERROR_MESSAGE_FORMAT_CORRUPT";
                    case 0x84:
                        return "RESPONSE_STATUS_ERROR_SENDING_ADDRESS_UNRESOLVED";

                    case 0x85:
                        return "RESPONSE_STATUS_ERROR_MESSAGE_NOT_FOUND";
                    case 0x86:
                        return "RESPONSE_STATUS_ERROR_NETWORK_PROBLEM";
                    case 0x87:
                        return "RESPONSE_STATUS_ERROR_CONTENT_NOT_ACCEPTED";
                    case 0x88:
                        return "RESPONSE_STATUS_ERROR_UNSUPPORTED_MESSAGE";
                    case 0xC0:
                        return "RESPONSE_STATUS_ERROR_TRANSIENT_FAILURE";

                    case 0xC1:
                        return "RESPONSE_STATUS_ERROR_TRANSIENT_SENDNG_ADDRESS_UNRESOLVED";
                    case 0xC2:
                        return "RESPONSE_STATUS_ERROR_TRANSIENT_MESSAGE_NOT_FOUND";
                    case 0xC3:
                        return "RESPONSE_STATUS_ERROR_TRANSIENT_NETWORK_PROBLEM";
                    case 0xC4:
                        return "RESPONSE_STATUS_ERROR_TRANSIENT_PARTIAL_SUCCESS";

                    case 0xE0:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_FAILURE";
                    case 0xE1:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_SERVICE_DENIED";
                    case 0xE2:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_MESSAGE_FORMAT_CORRUPT";
                    case 0xE3:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_SENDING_ADDRESS_UNRESOLVED";
                    case 0xE4:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_MESSAGE_NOT_FOUND";
                    case 0xE5:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_CONTENT_NOT_ACCEPTED";
                    case 0xE6:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_REPLY_CHARGING_LIMITATIONS_NOT_MET";
                    case 0xE7:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_REPLY_CHARGING_REQUEST_NOT_ACCEPTED";
                    case 0xE8:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_REPLY_CHARGING_FORWARDING_DENIED";
                    case 0xE9:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_REPLY_CHARGING_NOT_SUPPORTED";
                    case 0xEA:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_ADDRESS_HIDING_NOT_SUPPORTED";
                    case 0xEB:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_LACK_OF_PREPAID";
                    case 0xFF:
                        return "RESPONSE_STATUS_ERROR_PERMANENT_END";
                }
            ...
            case RETRIEVE_STATUS:
                ...
                switch (value) {
                    case 0x80:
                        return "RETRIEVE_STATUS_OK";
                    case 0xC0:
                        return "RETRIEVE_STATUS_ERROR_TRANSIENT_FAILURE";
                    case 0xC1:
                        return "RETRIEVE_STATUS_ERROR_TRANSIENT_MESSAGE_NOT_FOUND";
                    case 0xC2:
                        return "RETRIEVE_STATUS_ERROR_TRANSIENT_NETWORK_PROBLEM";
                    case 0xE0:
                        return "RETRIEVE_STATUS_ERROR_PERMANENT_FAILURE";
                    case 0xE1:
                        return "RETRIEVE_STATUS_ERROR_PERMANENT_SERVICE_DENIED";
                    case 0xE2:
                        return "RETRIEVE_STATUS_ERROR_PERMANENT_MESSAGE_NOT_FOUND";
                    case 0xE3:
                        return "RETRIEVE_STATUS_ERROR_PERMANENT_CONTENT_UNSUPPORTED";
                    case 0xFF:
                        return "RETRIEVE_STATUS_ERROR_END";
                }
            ...
            case SENDER_VISIBILITY:
                ...
                switch (value) {
                    case 0x80:
                        return "SENDER_VISIBILITY_HIDE";
                    case 0x81:
                        return "SENDER_VISIBILITY_SHOW";
                }
            ...
            case READ_STATUS:
                ...
                switch (value) {
                    ...
                    case 0x81:
                        return "READ_STATUS__DELETED_WITHOUT_BEING_READ";
                }
            ...
            case CANCEL_STATUS:
                ...
                switch (value) {
                    case 0x80:
                        return "CANCEL_STATUS_REQUEST_SUCCESSFULLY_RECEIVED";
                    case 0x81:
                        return "CANCEL_STATUS_REQUEST_CORRUPTED";
                }
            ...
            case REPLY_CHARGING:
                ...
                switch (value) {
                    case 0x80:
                        return "REPLY_CHARGING_REQUESTED";
                    case 0x81:
                        return "REPLY_CHARGING_REQUESTED_TEXT_ONLY";
                    case 0x82:
                        return "REPLY_CHARGING_ACCEPTED";
                    case 0x83:
                        return "REPLY_CHARGING_ACCEPTED_TEXT_ONLY";
                }
            ...
            case MM_STATE:
                ...
                switch (value) {
                    case 0x80:
                        return "MM_STATE_DRAFT";
                    case 0x81:
                        return "MM_STATE_SENT";
                    case 0x82:
                        return "MM_STATE_NEW";
                    case 0x83:
                        return "MM_STATE_RETRIEVED";
                    case 0x84:
                        return "MM_STATE_FORWARDED";
                }
            ...
            case RECOMMENDED_RETRIEVAL_MODE:
                ...
                switch (value) {
                    case 0x80:
                        return "RECOMMENDED_RETRIEVAL_MODE_MANUAL";
                }
            ...
            case CONTENT_CLASS:
                ...
                switch (value) {
                    case 0x80:
                        return "CONTENT_CLASS_TEXT";
                    case 0x81:
                        return "CONTENT_CLASS_IMAGE_BASIC";
                    case 0x82:
                        return "CONTENT_CLASS_IMAGE_RICH";
                    case 0x83:
                        return "CONTENT_CLASS_VIDEO_BASIC";
                    case 0x84:
                        return "CONTENT_CLASS_VIDEO_RICH";
                    case 0x85:
                        return "CONTENT_CLASS_MEGAPIXEL";
                    case 0x86:
                        return "CONTENT_CLASS_CONTENT_BASIC";
                    case 0x87:
                        return "CONTENT_CLASS_CONTENT_RICH";
                }
            ...
            case STORE_STATUS:
                ...
                switch (value) {
                    case 0x80:
                        return "STORE_STATUS_SUCCESS";
                    case 0xC0:
                        return "STORE_STATUS_ERROR_TRANSIENT_FAILURE";
                    case 0xC1:
                        return "STORE_STATUS_ERROR_TRANSIENT_NETWORK_PROBLEM";
                    case 0xE0:
                        return "STORE_STATUS_ERROR_PERMANENT_FAILURE";
                    case 0xE1:
                        return "STORE_STATUS_ERROR_PERMANENT_SERVICE_DENIED";
                    case 0xE2:
                        return "STORE_STATUS_ERROR_PERMANENT_MESSAGE_FORMAT_CORRUPT";
                    case 0xE3:
                        return "STORE_STATUS_ERROR_PERMANENT_MESSAGE_NOT_FOUND";
                    case 0xE4:
                        return "STORE_STATUS_ERROR_PERMANENT_MMBOX_FULL";
                    case 0xFF:
                        return "STORE_STATUS_ERROR_END";
                }
        }
        Log.w(TAG, "No value string for field: " + field + " value: " + value);
        return null;
    }

    public static String getLongValueString(int field, long value) {
        StringBuilder builder = new StringBuilder();
        switch (field) {
            // Dates
            case DATE:
            ...
            case PREVIOUSLY_SENT_DATE:
            case EXPIRY:
                builder.append(new Date(value));
                break;
            // Sizes
            case REPLY_CHARGING_SIZE:
            case MESSAGE_SIZE:
                builder.append((double) value / (double) 1024);
                builder.append("KB");
                break;
            // Counts
            case START:
