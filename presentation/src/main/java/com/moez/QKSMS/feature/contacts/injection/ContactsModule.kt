...
@Module
class ContactsModule(private val controller: ContactsController) {

    @Provides
    @ControllerScope
    @Named("isSharing")
    fun provideIsSharing(): Boolean {
    ...
    @ControllerScope
    @Named("chips")
    fun provideChips(): HashMap<String, String?> {
        return controller.chips
    }
