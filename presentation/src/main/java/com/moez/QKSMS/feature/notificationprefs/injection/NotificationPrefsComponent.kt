...
@ControllerScope
@Subcomponent(modules = [NotificationPrefsModule::class])
interface NotificationPrefsComponent {

    fun inject(controller: NotificationPrefsController)

    @Subcomponent.Builder
    interface Builder {
        fun contactsModule(module: NotificationPrefsModule): Builder
        fun build(): NotificationPrefsComponent
    }
